...
ax::NodeEditor::CreateEditor(const Config *config) {
...
bool ax::NodeEditor::IsActive() { return s_Editor->IsFocused(); }
...
bool ax::NodeEditor::GetLinkPins(LinkId linkId, PinId *startPinId,
                                 PinId *endPinId) {
...
int ax::NodeEditor::GetNodeCount() { return s_Editor->CountLiveNodes(); }
